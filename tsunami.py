...
class Tsunami:
    ...
    def calcRemainMarginWithFundingPaymentAndRolloverFee(self):
        ...
        unrealizedPnl = self.getPositionNotionalAndUnrealizedPnl(self.myAddress, 1)['value']
...
a = tsunami.calcRemainMarginWithFundingPaymentAndRolloverFee()
